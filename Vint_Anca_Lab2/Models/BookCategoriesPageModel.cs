...
namespace Vint_Anca_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel

    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Vint_Anca_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Vint_Anca_Lab2Context context,
